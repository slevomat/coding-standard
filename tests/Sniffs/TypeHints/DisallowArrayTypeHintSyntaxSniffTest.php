...
class DisallowArrayTypeHintSyntaxSniffTest extends TestCase
{
	...
	public function testErrors(): void
	{
		...
		self::assertSniffError($report, 50, DisallowArrayTypeHintSyntaxSniff::CODE_DISALLOWED_ARRAY_TYPE_HINT_SYNTAX, 'Usage of array type hint syntax in "string[][]" is disallowed, use generic type hint syntax instead.');
