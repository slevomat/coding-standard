...
class SuppressHelper
{
	...
	{
		return array_reduce(AnnotationHelper::getAnnotationsByName($phpcsFile, $pointer, self::ANNOTATION), function (bool $carry, Annotation $annotation) use ($suppressName): bool {
