 ...
 * @internal
 */
class ParameterOutAnnotation extends Annotation
{

	/** @var ParamOutTagValueNode|null */
	private $contentNode;

	public function __construct(string $name, int $startPointer, int $endPointer, ?string $content, ?ParamOutTagValueNode $contentNode)
	{
		if (!in_array($name, ['@param-out', '@psalm-param-out', '@phpstan-param-out'], true)) {
	...
	public function getContentNode(): ?ParamOutTagValueNode
	{
